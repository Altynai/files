...
\begin{body}
    ...
    \textbf{Junior Python Developer} \emph{@gezbox.com} \hfill \emph{July 2013 - Present}\\
    \vspace*{-4pt}
    \begin{itemize} \itemsep -0pt  % reduce space between items
        \item Develop and maintain Atom's server backend and internal systems using Django.(\emph{http://gezbox.com/lab/}).
        \item Designed and implemented the ordering system used in App(Feng XianSheng, \emph{http://123feng.com})
    \end{itemize}
